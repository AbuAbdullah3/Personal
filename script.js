...
const quizData = [
    {
        question: 'День рождения Хадичабону?',
        a: '24 Апрель',
        b: '06 Июль',
        c: '15 Октябрь',
        d: '12 Август',
        ...
        question: 'Кого из птиц называют санитаром леса?',
        a: 'Дятль',
        b: 'Сова',
        c: 'Ворона',
        d: 'Орёл',
        ...
        question: 'Какая птица не несёт яйца?',
        a: 'Ворона',
        b: 'Орёл',
        c: 'Петух',
        d: 'Страус',
        ...
        question: 'В каком городе родился Абдуллох?',
        a: 'Дубай',
        b: 'Москва',
        c: 'Ташкент',
        d: 'Пекин',
        ...
        question: 'Это есть у тебя, а пользуются другие. Что?',
        a: 'Рука',
        b: 'Деньги',
        c: 'Голова',
        d: 'Имя',
        ...
        question: 'День рождения Абдуллох?',
        a: '04 Май',
        b: '29 Апрель',
        c: '11 Октябрь',
        d: '09 Август',
        ...
        question: 'Поесть из этой посуды не получится. Из какой?',
        a: 'Деревянной',
        b: 'Золотой',
        c: 'Белой',
        d: 'Пустой',
        ...
        question: 'День рождения Санжарбек?',
        a: '24 Июнь',
        b: '17 Июнь',
        c: '05 Декабрь',
        d: '1 Август',
...
submitBtn.addEventListener("click", () => {
    ...
    if (answer) {
        ...
        if (currentQuiz < quizData.length) {
            ...
            quiz.innerHTML = `<h2> Вы правильно ответили на ${score}/${quizData.length} вопросов.</h2><button class="quiz" onClick="location.reload()">Перезагрузить</button>`;
        }
    }
});
...
{
    const sanBirthDay = "24 Jun 2023";

    function countdownSan() {
        const birthDayDate = new Date(sanBirthDay);
...
const hulBirthDay = "4 July 2023";

function countdownHul() {
    const hulBirthDayDate = new Date(hulBirthDay);
    const currentDate = new Date();
    const totalSecondsh = (hulBirthDayDate - currentDate) / 1000;

    const daysh = Math.floor(totalSecondsh / 3600 / 24);

    document.getElementById('daysh').innerHTML = daysh;
}

const abdBirthDay = "29 Apr 2024";

function countdownAbd() {
    const abdBirthDayDate = new Date(abdBirthDay);
    const currentDate = new Date();
    const totalSeconds = (abdBirthDayDate - currentDate) / 1000;

    const daysa = Math.floor(totalSeconds / 3600 / 24);

    document.getElementById('daysa').innerHTML = daysa;
}

const hadBirthDay = "12 Aug 2023";

function countdownHad() {
    const hadBirthDayDate = new Date(hadBirthDay);
    const currentDate = new Date();
    const totalSeconds = (hadBirthDayDate - currentDate) / 1000;

    const daysha = Math.floor(totalSeconds / 3600 / 24);

    document.getElementById('daysha').innerHTML = daysha;
}
